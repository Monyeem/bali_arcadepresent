import 'package:bali_arcade/Screens/Food_product.dart';
...
class FoodCategory extends StatefulWidget {
  ...
  // static String id='FoodCategoryScreen';
  @override
                          ...
                          Column(
                            children: <Widget>[
                              GestureDetector(
                                ...
                                onTap:(){
                                  setState(() {
                                    Navigator.of(context).push(MaterialPageRoute(builder: (context) => FoodProduct()));
